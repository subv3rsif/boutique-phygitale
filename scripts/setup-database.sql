...
CREATE INDEX "accounts_compound_key" ON "accounts" USING btree ("provider","provider_account_id");--> statement-breakpoint
CREATE INDEX "idx_status_retry" ON "email_queue" USING btree ("status","next_retry_at");--> statement-breakpoint
CREATE INDEX "idx_order_email" ON "email_queue" USING btree ("order_id");--> statement-breakpoint
CREATE INDEX "idx_order" ON "order_items" USING btree ("order_id");--> statement-breakpoint
CREATE INDEX "idx_refdet" ON "orders" USING btree ("refdet");--> statement-breakpoint
CREATE INDEX "idx_idop_order" ON "orders" USING btree ("idop");--> statement-breakpoint
CREATE INDEX "idx_email" ON "orders" USING btree ("customer_email");--> statement-breakpoint
CREATE INDEX "idx_status" ON "orders" USING btree ("status");--> statement-breakpoint
CREATE INDEX "idx_idop" ON "payfip_operations" USING btree ("idop");--> statement-breakpoint
CREATE INDEX "idx_order_payfip" ON "payfip_operations" USING btree ("order_id");--> statement-breakpoint
CREATE INDEX "idx_refdet_payfip" ON "payfip_operations" USING btree ("refdet");--> statement-breakpoint
CREATE INDEX "idx_expires" ON "payfip_operations" USING btree ("expires_at");--> statement-breakpoint
CREATE INDEX "idx_hash" ON "pickup_tokens" USING btree ("token_hash");--> statement-breakpoint
CREATE INDEX "idx_order_token" ON "pickup_tokens" USING btree ("order_id");--> statement-breakpoint
CREATE INDEX "verification_tokens_compound_key" ON "verification_tokens" USING btree ("identifier","token");CREATE TABLE "products" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
...
CREATE INDEX "idx_products_stock" ON "products" USING btree ("stock_quantity");--> statement-breakpoint
CREATE INDEX "idx_stock_product" ON "stock_movements" USING btree ("product_id");--> statement-breakpoint
CREATE INDEX "idx_stock_order" ON "stock_movements" USING btree ("order_id");